...
class Main extends hxd.App {
    ...
    override function init() {
        ...
        var block5 = new PhysicsEntity(new Vector(500,0), new Vector(60,60), new ColorRenderer(0xAAFF00), new Vector(-1,0));
        var block5 = new PhysicsEntity(new Vector(760,-50), new Vector(100,20), new ColorRenderer(0x00AAFF), new Vector(0,0));
        var block5 = new PhysicsEntity(new Vector(100,300), new Vector(30,50), new ColorRenderer(0xFF00AA), new Vector(20,0));
    }
